#!/bin/bash -l
#SBATCH -p batch -N 1 -n 1  --mem 64G --out logs/E.musRL%A.log 
...
#do
name=Entomophthora_muscae_UCB.Nanopore10X_v2
genome=/rhome/xxu092/bigdata/EDTA/genome/Entomophthora_muscae_UCB.Nanopore10X_v2.fasta
twoBit=/rhome/xxu092/bigdata/EDTA/RepeatLandscape-DeepTE/Entomophthora_muscae_UCB.Nanopore10X_v2.2bit
